...
async function main() {
  ...
  const payloads = [
    { contract_address: contractAddress, chain, signature: "0x1234" },
    { poolAddress: contractAddress, chain, signature: "0x1234" },
    { pool_address: contractAddress, chain, signature: "0x1234" },
    { contract: contractAddress, chain, signature: "0x1234" }
  ];
